...
public class ProductsDatabase {
    ...
    private Map<String, FoodProduct> initializeProductsDatabase() {
        ...
        // Фастфуд и бургеры (расширенная база)
        addProduct(db, "бургер", 540, 25.0, 31.0, 40.0, "фастфуд");
        addProduct(db, "куриный бургер", 520, 28.0, 26.0, 45.0, "фастфуд");
        addProduct(db, "чизбургер", 563, 27.0, 33.0, 42.0, "фастфуд");
        addProduct(db, "биг мак", 563, 25.0, 33.0, 45.0, "фастфуд");
        addProduct(db, "воппер", 660, 28.0, 40.0, 49.0, "фастфуд");
        addProduct(db, "сэндвич с курицей", 480, 24.0, 22.0, 41.0, "фастфуд");
        addProduct(db, "клаб сэндвич", 590, 30.0, 28.0, 47.0, "фастфуд");
    ...
    private Map<String, List<String>> initializeCategoryKeywords() {
        ...
        keywords.put("фастфуд", Arrays.asList("бургер", "сэндвич", "пицца", "шаурма", "фри", "наггетсы"));
        keywords.put("бургер", Arrays.asList("бургер", "чизбургер", "сэндвич", "биг мак", "воппер"));
